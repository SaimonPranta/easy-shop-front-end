  ...
  const withdrawFormHandler = async (e) => {
    ...
    try {
      const res = await fetch(
        `${process.env.REACT_APP_SERVER_HOST_URL}/withdraw`,
        {
          method: "POST",
      ...
      <div className="inner-section">
        ...
        <div className="form-container">
          <div className="notice-notice">
            <p>স্যালারি বোনাস পাওয়ার জন্য নিচের শর্ত অনুযায়ী কাজ করু।</p>
          </div>
          <div className="notice-notice white des">
            <p>স্যালারি বোনাস গ্রহণ করার নিয়ম</p>
            <div className="more-btn-container">
              <button>see more</button>
            </div>
          </div>
          <div className="notice-notice white">
            <p>স্যালারি বোনাস পাওয়ার জন্য নিয়মত রেফার করুন এবং টিম গঠন করুন।</p>
          </div>
              ...
              {new Array(5).fill("").map((itemInfo, index) => {
                return (
                  <div className="cart">
                    ...
                    <div className="des">
                      <p>
                        অভিনন্দন, আপনি টার্গেট সম্পূর্ণ করে স্যালারি বোনাস
                        পেয়েছেন।
                      </p>
                    </div>
